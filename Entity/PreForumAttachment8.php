 ...
 * PreForumAttachment8
 *
 * @ORM\Table(name="pre_forum_attachment_8", indexes={@ORM\Index(name="tid", columns={"tid"}), @ORM\Index(name="pid", columns={"pid"}), @ORM\Index(name="uid", columns={"uid"})})
 * @ORM\Entity
 */
class PreForumAttachment8
{
    /**
     * @var integer
     *
