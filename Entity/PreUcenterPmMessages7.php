...
/**
 * PreUcenterPmMessages7
 *
 * @ORM\Table(name="pre_ucenter_pm_messages_7", indexes={@ORM\Index(name="plid", columns={"plid", "delstatus", "dateline"}), @ORM\Index(name="dateline", columns={"plid", "dateline"})})
 * @ORM\Entity
 */
class PreUcenterPmMessages7
{
    /**
     * @var integer
     *
