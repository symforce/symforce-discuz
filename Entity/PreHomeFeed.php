 ...
 * PreHomeFeed
 *
 * @ORM\Table(name="pre_home_feed", indexes={@ORM\Index(name="uid", columns={"uid", "dateline"}), @ORM\Index(name="dateline", columns={"dateline"}), @ORM\Index(name="hot", columns={"hot"}), @ORM\Index(name="id", columns={"id", "idtype"})})
 * @ORM\Entity
 */
class PreHomeFeed
{
