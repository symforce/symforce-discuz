...
/**
 * PreUcenterPmMessages3
 *
 * @ORM\Table(name="pre_ucenter_pm_messages_3", indexes={@ORM\Index(name="plid", columns={"plid", "delstatus", "dateline"}), @ORM\Index(name="dateline", columns={"plid", "dateline"})})
 * @ORM\Entity
 */
class PreUcenterPmMessages3
{
    /**
     * @var integer
     *
