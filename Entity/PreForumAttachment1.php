 ...
 * PreForumAttachment1
 *
 * @ORM\Table(name="pre_forum_attachment_1", indexes={@ORM\Index(name="tid", columns={"tid"}), @ORM\Index(name="pid", columns={"pid"}), @ORM\Index(name="uid", columns={"uid"})})
 * @ORM\Entity
 */
class PreForumAttachment1
{
    /**
     * @var integer
     *
