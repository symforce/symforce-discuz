 ...
 * PreForumAttachment2
 *
 * @ORM\Table(name="pre_forum_attachment_2", indexes={@ORM\Index(name="tid", columns={"tid"}), @ORM\Index(name="pid", columns={"pid"}), @ORM\Index(name="uid", columns={"uid"})})
 * @ORM\Entity
 */
class PreForumAttachment2
{
    /**
     * @var integer
     *
