...
/**
 * PreHomeFollowFeedArchiver
 *
 * @ORM\Table(name="pre_home_follow_feed_archiver", indexes={@ORM\Index(name="uid", columns={"uid", "dateline"})})
 * @ORM\Entity
 */
class PreHomeFollowFeedArchiver
{
    /**
     * @var integer
     *
     ...
     *
     * @param integer $uid
     * @return PreHomeFollowFeedArchiver
     */
